...
$offersList = \Offers\OfferManager::fetchOrderFormsList($db, $user, $isOwner, $isAdmin);
$db = null;
?>
<h2 class="page-header text-lg-center">Liste des bons de commande disponibles</h2>
<table class="table sortTable table-striped table-hover text-small">
    ...
    foreach($offersList as $offer):
        ...
        <tr class="hoverable" data-href="/commande-vehicules/offre-de-prix/visualiser/<?php echo $offerReference; ?>">
            ...
            <td>
                <a href="/commande-vehicules/bons-de-commande/visualiser/<?php echo $offerReference; ?>" class="btn btn-primary-outline btn-sm fa fa-eye" title="Visualiser"></a>
                <a href="/commande-vehicules/bons-de-commande/imprimer/<?php echo $offerReference; ?>" class="btn btn-primary-outline btn-sm fa fa-print" title="Imprimer" target="_blank"></a>
                <a href="/commande-vehicules/bons-de-commande/signer/<?php echo $offerReference; ?>" class="btn btn-success-outline btn-sm fa fa-check" title="Valider la signature"></a>
            </td>
        </tr>
        <?php
    endforeach;
