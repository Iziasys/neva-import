...
<div class="container">
    <h3 class="page-header">Visualisation des packs disponibles</h3>
    <div class="col-lg-12">
        <label for="selectFinishForPack" class="col-lg-2 form-control-label">Finition concernée :</label>
        <div class="col-lg-10">
            <select id="selectFinishForPack" class="form-control">
    ...
    <table class="table table-striped table-hover sortable">
        ...
        <tbody id="receiverPackInformation">
